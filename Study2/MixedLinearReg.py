...
# Define time periods (e.g., by day) without losing timezone information
df['Time_Period'] = df['created_utc'].dt.to_period('S')
...
mixed_model = sm.MixedLM(new_df['Predicted_Label'], sm.add_constant(new_df['elapsed_time']), groups=new_df['anon'])
